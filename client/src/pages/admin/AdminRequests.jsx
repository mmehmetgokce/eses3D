        ...
        <div className="animate-fade-in">
            ...
            {selectedRequest && (
                <div className="fixed inset-0 bg-black/50 flex items-start justify-center z-50 p-4 overflow-y-auto">
                    <div className="bg-white dark:bg-dark-800 border border-light-300 dark:border-dark-700 rounded-xl w-full max-w-2xl my-8 animate-fade-in flex flex-col" style={{ maxHeight: 'calc(100vh - 4rem)' }}>
                        ...
                        <div className="p-4 space-y-4 overflow-y-auto flex-1" style={{ minHeight: 0 }}>
                            {/* Customer Info */}
                                    ...
                                    {statusOptions.slice(1).map((opt) => (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${selectedRequest.status === opt.value
                                                ...
                                                : 'bg-light-200 dark:bg-dark-700 text-light-700 dark:text-dark-300 hover:bg-light-300 dark:hover:bg-dark-600 border border-light-300 dark:border-dark-600'
                                                }`}
                                        >
                                            {opt.label}
                                        </button>
